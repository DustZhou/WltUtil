...
object DateExtendUtil {
    ...
    fun getHistoryBeginDate(dateType: DateEnum): String {
        ...
        when (dateType) {
            ...
            DateEnum.WEEK -> calendar.add(Calendar.DATE, -7)
            DateEnum.Next7Days -> calendar.add(Calendar.DATE, 7)
            DateEnum.Next30Days -> calendar.add(Calendar.DATE, 30)
            DateEnum.THIRTY_DAYS -> calendar.add(Calendar.DATE, -30)
            DateEnum.DAYS_180 -> calendar.add(Calendar.DATE, -180)

...
*/
public class AddAndSubtractTextView extends FrameLayout implements View.OnClickListener {
    ...
    // EditText
    private WltTextView etMain;

    public AddAndSubtractTextView(@NonNull Context context) {
        this(context, null);
    }

    public AddAndSubtractTextView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AddAndSubtractTextView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
